...
<div class="container-fluid px-4">
    <h5 class="mt-4 textColor">Edit Tenant Details </h5>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class=" card myShadow border-0 rounded-lg">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('tenant.update', $tenant_id->id) }}">
                        @method('PUT')
                        @csrf
                        {{-- success message --}}
                        @if (session('success'))
                        ...
                        <div class="form-floating mb-3">
                            <input id="name" type="text" class="form-control" name="name" required autocomplete="name"
                                autofocus placeholder="Tenant Name" value="{{ $tenant_id->name }}">
                        ...
                        <div class="form-floating mb-3">
                            <input id="nid" type="number" class="form-control" name="nid" required autocomplete="nid"
                                autofocus placeholder="NID Number" value="{{ $tenant_id->nid }}">
                        ...
                        <div class="form-floating mb-3">
                            <input value="{{ $tenant_id->date_of_b }}" id="date_of_b" type="date" class="form-control"
                                name="date_of_b" value="" required autocomplete="date_of_b"
                                placeholder="Ex: 12/11/2020">
